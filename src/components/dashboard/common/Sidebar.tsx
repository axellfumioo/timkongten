...
export default function Sidebar({ isMobile, isOpen, onClose }: SidebarProps) {
  ...
  const baseClasses =
    "bg-[#0b0b0b] border-r border-white/10 flex flex-col justify-between";
  ...
  const desktopClasses =
    "hidden md:flex md:w-72 md:flex-col md:justify-between md:h-screen md:p-6 overflow-y-auto";
